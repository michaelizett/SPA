...
if ($products->have_posts()) :
    ...
    <div class="woo-nav-links">
        <ul>
            <?php
                previous_post_link( '<li class="nav-previous">%link</li>', '<span class="page-numbers"><i class="fa fa-long-arrow-left"></i></span>' );
                next_post_link(     '<li class="nav-next">%link</li>',     '<span class="page-numbers"><i class="fa fa-long-arrow-right"></i></span>' );
            ?>
        </ul>
    </div><!-- .nav-links -->
    <div id="cms-related-product-<?php echo esc_attr($date); ?>" class="cms-related-products-wrapper clearfix">
        <div class="cms-related-heading">
            <h3 class="wg-title"><span><?php esc_html_e('Related Products', "wp-experts"); ?></span></h3>
        </div>
        <div class="products">
