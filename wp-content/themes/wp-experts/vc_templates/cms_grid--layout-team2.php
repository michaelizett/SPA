...
?>
<div class="layout-team team-layout2 filtrer-center cms-grid-wraper <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
            ...
            <div class="cms-grid-item cms-team-item <?php echo esc_attr($atts['item_class']);?>" data-groups='[<?php echo implode(',', $groups);?>]'>
                <div class="cms-grid-item-inner cms-team-item-inner row clearfix">
                    ...
                    <div class="cms-team-content col-xs-12 col-sm-6 col-md-8 col-lg-8">
                        ...
                        <div class="cms-team-desc"><?php echo substr(get_the_excerpt(), 0,200); ?>...</div>
