...
?>
<div class="cms-fancyboxes-wraper cms-fancyboxes-layout2 text-<?php echo esc_attr($box_align); ?> <?php if($box_icon == 'yes') { echo 'box-icon'; } ?> <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php if($atts['title']!=''):?>
