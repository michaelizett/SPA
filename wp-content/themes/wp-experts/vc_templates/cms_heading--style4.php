...
?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="cms-heading-wrapper heading-style4 text-<?php echo esc_attr($content_align); ?> <?php echo esc_attr($custom_class); ?>">
    <style type="text/css" scoped>
        #<?php echo esc_attr($atts['html_id']);?>.heading-style4 .line-icon:before, #<?php echo esc_attr($atts['html_id']);?>.heading-style4 .line-icon::after {
