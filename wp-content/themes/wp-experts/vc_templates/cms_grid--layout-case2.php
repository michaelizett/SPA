...
?>
<div class="cms-grid-wraper case-layout cms-case-layout2 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
            ...
            <div class="cms-grid-item <?php echo esc_attr($atts['item_class']);?>" data-groups='[<?php echo implode(',', $groups);?>]'>
                ...
                <div class="grid-case-body <?php echo esc_attr($class); ?>">
                    <div class="grid-case-image">
                        <?php echo ''.$thumbnail.''; ?>
                        <div class="grid-case-content-hover">
