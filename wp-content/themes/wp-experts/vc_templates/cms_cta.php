...
?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="cms-cta-wrapper cms-style-default style1 clearfix <?php echo esc_attr($el_class); ?> <?php echo esc_attr($button_align); ?>">
